package jp.co.translacat.domain.chat.message.dto.websocket.request;
...
public record ChatMessageSendRequestDto(
    ...
    public ChatMessageCreateRequestDto toCreateRequest() {
        return new ChatMessageCreateRequestDto(content);
    }
}