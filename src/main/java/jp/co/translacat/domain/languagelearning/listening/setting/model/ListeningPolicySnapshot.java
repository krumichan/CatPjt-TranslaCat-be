...
public record ListeningPolicySnapshot(
    ...
    public int getDefaultItemCount() { return defaultItemCount; }
    public int getMinItemCount() { return minItemCount; }
    public int getMaxItemCount() { return maxItemCount; }
    public int getHardItemLimit() { return hardItemLimit; }
    public int getReferenceAudioMaxSeconds() { return referenceAudioMaxSeconds; }
    public int getRepeatAudioMaxSeconds() { return repeatAudioMaxSeconds; }
    public long getMaxAudioFileBytes() { return maxAudioFileBytes; }
    public int getMaxRerecordCount() { return maxRerecordCount; }
    public int getResumeHours() { return resumeHours; }
    public int getReferenceAudioRetentionDays() { return referenceAudioRetentionDays; }
    public int getUserAudioRetentionDays() { return userAudioRetentionDays; }
    public int getReportedAudioRetentionDays() { return reportedAudioRetentionDays; }
    public int getAutomaticRetryLimit() { return automaticRetryLimit; }
    public int getManualRetryLimit() { return manualRetryLimit; }
    public int getPracticeAttemptLimit() { return practiceAttemptLimit; }
    public String getProfilePolicyVersion() { return profilePolicyVersion; }
    public String getModelConfigVersion() { return modelConfigVersion; }
    public boolean isReferenceTtsRegenerationEnabled() { return referenceTtsRegenerationEnabled; }
