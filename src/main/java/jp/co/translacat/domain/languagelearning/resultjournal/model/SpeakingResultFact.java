 ...
 */
public record SpeakingResultFact(String resultKind, long evaluationId, long sessionId, Long activityId,
                                 String learningDate, String originLanguage, String learningLanguage, boolean formal,
                                 double activityWeight, AiSpeakingEvaluationResponseDto response) {
    @Override
