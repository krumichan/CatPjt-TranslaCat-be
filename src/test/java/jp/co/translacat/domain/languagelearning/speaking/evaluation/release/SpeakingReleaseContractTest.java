...
class SpeakingReleaseContractTest {
    ...
    void rejectsResponseForAnotherRequestOrSession(String field) throws Exception {
        ...
        assertThatThrownBy(() -> validator.validate(response, request("evaluated"))).isInstanceOf(
    ...
    void rejectsInsufficientEvidenceCarryingAnOverallScore() throws Exception {
        ...
        assertThatThrownBy(() -> validator.validate(value, request("precheck-insufficient"))).isInstanceOf(
                BusinessException.class);
    }
    ...
    void rejectsInvalidConfidence(double confidence) {
        ...
        assertThatThrownBy(() -> validator.validate(changed, request("evaluated"))).isInstanceOf(
                BusinessException.class);
    }
