...
public final class SpeakingReleaseFixtures {
    ...
    public static AiSpeakingEvaluationRequestDto request(String name) {
        try {
            return JSON.treeToValue(fixture(name).get("request"), AiSpeakingEvaluationRequestDto.class);
        } catch (Exception e) {
            throw new IllegalStateException(e);
        }
    }
    ...
    public static AiSpeakingEvaluationResponseDto response(String name) {
        try {
            return JSON.treeToValue(fixture(name).get("response"), AiSpeakingEvaluationResponseDto.class);
        } catch (Exception e) {
            throw new IllegalStateException(e);
        }
    }
