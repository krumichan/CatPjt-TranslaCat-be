...
class KeywordInternalJwtTest {
    ...
    @Test void userTokenCarriesOnlyVerifiedUserAndMandatoryLearningFact() {
        ...
        assertEquals(Boolean.FALSE, claims(provider().issueKeywordUserToken(123L, false)).get("keywordLearningStarted", Boolean.class));
    }
    @Test void administratorTokenUsesActualActorAndDistinctKeywordPurpose() {
    ...
    @Test void originalSettingsTokenPurposesAreNotChanged() {
    ...
    @Test void invalidSubjectsAreRejectedBeforeSigning() {
