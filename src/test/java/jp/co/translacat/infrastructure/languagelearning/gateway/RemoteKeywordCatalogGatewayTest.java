...
class RemoteKeywordCatalogGatewayTest {
    ...
    @Test void disabledRemoteNeverFallsBackToCoreCatalog() {
    ...
    @Test void unknownUserDoesNotGetAnInternalTokenOrRemoteWrite() {
    ...
    @Test void coreLearningFactAndLocaleArePassedWithoutFabricatedUser() {
    ...
    @Test void creationAndSelectionUseCurrentCoreFact() {
        var change = new KeywordCreateRequestDto("IT", KeywordType.TOPIC, null, null, null);
    ...
    @Test void administratorIdentityIsNotReplacedByAnArbitraryId() {
    ...
    @Test void candidateDateAndRemoteFailureArePreservedWithoutRetry() {
